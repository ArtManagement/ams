class ConsignListsController < ApplicationController
  ...
  def search
    ...
    " SELECT
     ...
     @consign_search_data =  Consign.find_by_sql([sql,{date_from: date_from, date_to: date_to,
     ...
     render json: @consign_search_data
  end
  ...
  def print
    ...
    # order情報を設定したThinReportを作成する
       report = ConsignListsPDF.create @consign

       # ブラウザでPDFを表示する
       # disposition: "inline" によりダウンロードではなく表示させている
         send_data report.generate,
           filename:    "consign_lists.pdf",
